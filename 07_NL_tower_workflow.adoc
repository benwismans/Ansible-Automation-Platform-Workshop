...
* Log in op ``Gitlab`` en voeg de volgende 3 files toe (Kijk eventueel terug in link:01_NL_gitlab[Lab 1]):
* ``webservers.yml``
+
...
[#workflow_01.png]
.Workflow results
image::workflow_01.png[workflow]
====
...
[#workflow_02.png]
.Workflow results
image::workflow_02.png[workflow]
====
...
[#workflow_03.png]
.Workflow results
image::workflow_03.png[workflow]
====
